 ...
 */
public class ClockSignal extends InstanceFactory implements StdCommandParser.CommandListener {
    ...
    public void propagate(InstanceState state) {
        ...
        // Check for new tick commands (for backward compatibility with timer-based polling)
        ...
        // Note: Commands are already cleared by getTickCommands() - no need to clear again
    ...
    // CommandListener callback - called immediately when a tick command is received
    @Override
    ...
    // CommandListener callback - called when a store command is received (not used by ClockSignal)
    @Override
    public void onStoreCommand(String command, StdCommandParser.StoreCommand storeCmd) {
        // Not used
    }
    
    // CommandListener callback - called when a print command is received (not used by ClockSignal)
    @Override
